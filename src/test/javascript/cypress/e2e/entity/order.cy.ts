...
describe('Order e2e test', () => {
  ...
  const orderSample = { title: 'plaintive silent', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-22T10:03:21.239Z' };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="title"]`).type('anxious');
      cy.get(`[data-cy="title"]`).should('have.value', 'anxious');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-23T06:58');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-23T06:58');

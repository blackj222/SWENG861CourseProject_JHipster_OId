...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'e8600e4f-4e2e-4a69-bd9b-d80fa712c5bb' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('34fd52f9-5cb7-415d-a494-b130b610368a');
      cy.get(`[data-cy="name"]`).should('have.value', '34fd52f9-5cb7-415d-a494-b130b610368a');

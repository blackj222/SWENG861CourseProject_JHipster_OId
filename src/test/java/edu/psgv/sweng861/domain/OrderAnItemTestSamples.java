...
public class OrderAnItemTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static OrderAnItem getOrderAnItemSample1() {
        return new OrderAnItem()
            .id(1L)
            .asin("asin1")
    ...
    public static OrderAnItem getOrderAnItemSample2() {
        return new OrderAnItem()
            .id(2L)
            .asin("asin2")
    ...
    public static OrderAnItem getOrderAnItemRandomSampleGenerator() {
        return new OrderAnItem()

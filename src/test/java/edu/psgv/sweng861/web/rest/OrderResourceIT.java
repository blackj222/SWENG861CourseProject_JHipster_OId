...
import static edu.psgv.sweng861.domain.OrderAsserts.*;
...
import edu.psgv.sweng861.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);

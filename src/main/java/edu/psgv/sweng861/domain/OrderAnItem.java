 ...
 */
@Entity
@Table(name = "order_an_item")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderAnItem implements Serializable {
    ...
    public OrderAnItem asin(String asin) {
        this.setAsin(asin);
        return this;
    }
    ...
    public OrderAnItem productTitle(String productTitle) {
    ...
    public OrderAnItem productPrice(String productPrice) {
    ...
    public OrderAnItem productOriginalPrice(String productOriginalPrice) {
    ...
    public OrderAnItem currency(String currency) {
    ...
    public OrderAnItem productStarRating(String productStarRating) {
    ...
    public OrderAnItem productNumRatings(Integer productNumRatings) {
    ...
    public OrderAnItem productUrl(String productUrl) {
    ...
    public OrderAnItem productPhoto(String productPhoto) {
    ...
    public OrderAnItem productNumOffers(Integer productNumOffers) {
    ...
    public OrderAnItem productMinimumOfferPrice(String productMinimumOfferPrice) {
    ...
    public OrderAnItem isBestSeller(Boolean isBestSeller) {
    ...
    public OrderAnItem isAmazonChoice(Boolean isAmazonChoice) {
    ...
    public OrderAnItem isPrime(Boolean isPrime) {
    ...
    public OrderAnItem climatePledgeFriendly(Boolean climatePledgeFriendly) {
    ...
    public OrderAnItem salesVolume(String salesVolume) {
    ...
    public OrderAnItem delivery(String delivery) {
    ...
    public OrderAnItem couponText(String couponText) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderAnItem)) {
            return false;
        }
        return getId() != null && getId().equals(((OrderAnItem) o).getId());
    }

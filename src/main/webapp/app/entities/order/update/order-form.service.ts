...
type OrderFormGroupContent = {
  ...
  title: FormControl<OrderFormRawValue['title']>;
  content: FormControl<OrderFormRawValue['content']>;
  date: FormControl<OrderFormRawValue['date']>;
  employeeInformation: FormControl<OrderFormRawValue['employeeInformation']>;
};
...
export class OrderFormService {
  createOrderFormGroup(order: OrderFormGroupInput = { id: null }): OrderFormGroup {
    ...
    return new FormGroup<OrderFormGroupContent>({
      ...
      title: new FormControl(orderRawValue.title, {
        validators: [Validators.required],
      }),
      content: new FormControl(orderRawValue.content, {
        validators: [Validators.required],
      }),
      date: new FormControl(orderRawValue.date, {
        validators: [Validators.required],
      }),
      employeeInformation: new FormControl(orderRawValue.employeeInformation),
    });
  }

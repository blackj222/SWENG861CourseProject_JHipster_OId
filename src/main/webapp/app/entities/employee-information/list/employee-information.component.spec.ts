...
import { sampleWithRequiredData } from '../employee-information.test-samples';
...
describe('EmployeeInformation Management Component', () => {
  let comp: EmployeeInformationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, EmployeeInformationComponent],
      providers: [
        {
      ...
      .overrideTemplate(EmployeeInformationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeInformations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeInformationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeInformationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeInformationIdentifier).toHaveBeenCalledWith(entity);
